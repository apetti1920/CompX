...
export function RectsOverlap(rect1: RectIdentifier, rect2: RectIdentifier): boolean {
  const l1 = { x: rect1.position.x - rect1.size.x / 2, y: rect1.position.y + rect1.size.y / 2 };
  const r1 = { x: rect1.position.x + rect1.size.x / 2, y: rect1.position.y - rect1.size.y / 2 };
  const l2 = { x: rect2.position.x - rect2.size.x / 2, y: rect2.position.y + rect2.size.y / 2 };
  const r2 = { x: rect2.position.x + rect2.size.x / 2, y: rect2.position.y - rect2.size.y / 2 };
