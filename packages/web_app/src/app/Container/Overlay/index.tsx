          ...
          <Container fluid style={{ height: '50px', padding: this.TopPadding }}>
            <Navbar style={{ height: '100%' }}>
              <Container fluid>
                ...
                >
                  <Logo color={this.props.theme.palette.text} size="30" /> CompX
                </Navbar.Brand>
          ...
          <Container fluid style={{ height: '40px', padding: this.TopPadding }}>
            <div
              style={{
                width: '100%',
                height: '100%',
                backgroundColor: this.props.theme.palette.text,
                borderRadius: '20px',
                display: 'flex',
                flexFlow: 'row nowrap',
            ...
            >
              ...
              >
                <Play
                  stroke={this.props.theme.palette.shadow}
                ...
                <Form.Control
                  ...
                  style={{
                    width: '200px',
                    backgroundColor: this.props.theme.palette.shadow,
                    color: this.props.theme.palette.text
                  }}
